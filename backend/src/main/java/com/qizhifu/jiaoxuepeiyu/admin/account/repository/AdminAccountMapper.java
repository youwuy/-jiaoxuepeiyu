...
public interface AdminAccountMapper {
    ...
    @Select("<script>"
            ...
            + "u.face_file_id, face_file.file_url AS face_file_url, "
            + "CASE WHEN u.face_file_id IS NULL THEN FALSE ELSE TRUE END AS face_recorded, "
            + "u.fingerprint_file_id, fingerprint_file.file_url AS fingerprint_file_url, "
            ...
            + "LEFT JOIN sys_uploaded_file face_file ON face_file.id = u.face_file_id "
            + "LEFT JOIN sys_uploaded_file fingerprint_file ON fingerprint_file.id = u.fingerprint_file_id "
