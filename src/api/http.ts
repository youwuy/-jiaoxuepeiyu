...
const apiMessageMap: Record<string, string> = {
  ...
  'Academic year already exists': '该学年已存在',
  'Academic year format must be YYYY-YYYY': '学年格式应为 YYYY-YYYY，且结束年份必须为开始年份的下一年',
  'Academic year name is required': '请选择学年',
  ...
  'Semester is required': '请选择学期',
  'Semester not found': '所选学期不存在，请刷新后重试',
  ...
  'Training academic year and semester are required': '请选择实训所属学年学期',
  'Training classes are required': '请选择参训班级或学员',
  'Training cover is required': '实训封面不能为空',
